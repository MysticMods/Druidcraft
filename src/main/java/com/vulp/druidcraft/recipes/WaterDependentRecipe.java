...
public class WaterDependentRecipe extends ShapedRecipe {
  ...
  private static PlayerEntity findPlayer(CraftingInventory inventory) {
    ...
    if (container instanceof PlayerContainer) {
      return (PlayerEntity) ObfuscationReflectionHelper.getPrivateValue(PlayerContainer.class, (PlayerContainer) container, "field_82862_h");
    } else if (container instanceof WorkbenchContainer && container.getSlot(0) instanceof CraftingResultSlot) {
      return (PlayerEntity) ObfuscationReflectionHelper.getPrivateValue(CraftingResultSlot.class, (CraftingResultSlot) container.getSlot(0), "field_75238_b");
    } else {
      return null;
    }
  }
  ...
  public static class Serializer extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<WaterDependentRecipe> {
    @Override
