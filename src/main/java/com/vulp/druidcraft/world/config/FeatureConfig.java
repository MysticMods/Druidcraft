...
public class FeatureConfig {
  public static class Trees {
    ...
    public static final BaseTreeFeatureConfig elder_tree = new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(BlockRegistry.elder_log.getDefaultState()), new SimpleBlockStateProvider(BlockRegistry.elder_leaves.getDefaultState()), new BlobFoliagePlacer(FeatureSpread.func_242252_a(0), FeatureSpread.func_242252_a(0), 0), new StraightTrunkPlacer(0, 0, 0), new TwoLayerFeature(0, 0, 0)).build();
  }
  public static class Bushes {
    ...
    public static BlockClusterFeatureConfig lavender = new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BlockRegistry.lavender.getDefaultState()), new SimpleBlockPlacer()).tries(64).build();
  }
}
