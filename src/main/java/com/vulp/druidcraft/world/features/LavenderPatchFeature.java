...
public class LavenderPatchFeature extends ScatteredPlantFeature {
    public LavenderPatchFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn, BlockState plantIn) {
