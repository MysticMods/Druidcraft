...
public class CrateTileEntityOld extends LockableLootTileEntity {
    private NonNullList<ItemStack> field_213966_a = NonNullList.withSize(27, ItemStack.EMPTY);
    private int field_213967_b;

    private CrateTileEntityOld(TileEntityType<?> p_i49963_1_) {
        super(p_i49963_1_);
    }

    public CrateTileEntityOld() {
        this(TileEntityRegistry.old_crate);
    }
