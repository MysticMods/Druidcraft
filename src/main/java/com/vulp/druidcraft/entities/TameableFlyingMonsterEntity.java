...
import com.vulp.druidcraft.advancements.DruidcraftAdvancements;
...
public class TameableFlyingMonsterEntity extends CreatureEntity {
    static final DataParameter<Byte> TAMED = EntityDataManager.createKey(TameableFlyingMonsterEntity.class, DataSerializers.BYTE);
    private static final DataParameter<Optional<UUID>> OWNER_UNIQUE_ID = EntityDataManager.createKey(TameableFlyingMonsterEntity.class, DataSerializers.OPTIONAL_UNIQUE_ID);
    SitGoalMonster sitGoal;

    TameableFlyingMonsterEntity(EntityType<? extends TameableFlyingMonsterEntity> type, World worldIn) {
        super(type, worldIn);
        this.setupTamedAI();
    ...
    void setTamedBy(PlayerEntity player) {
        ...
        if (player instanceof ServerPlayerEntity) {
            DruidcraftAdvancements.TAME_MONSTER.trigger((ServerPlayerEntity)player, this);
        }
