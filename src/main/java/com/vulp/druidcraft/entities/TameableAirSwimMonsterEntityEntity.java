...
public class TameableAirSwimMonsterEntityEntity extends TameableMonsterEntity {

    TameableAirSwimMonsterEntityEntity(EntityType<? extends TameableMonsterEntity> type, World p_i48553_2_) {
        super(type, p_i48553_2_);
    }

    @Override
    public FlyingPathNavigator getNavigator() {
        if (this.isPassenger() && this.getRidingEntity() instanceof TameableAirSwimMonsterEntityEntity) {
