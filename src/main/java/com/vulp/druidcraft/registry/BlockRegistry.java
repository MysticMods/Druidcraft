...
public class BlockRegistry {
  ...
  public static Block heavily_overgrown_nylium = register("heavily_overgrown_nylium", new NyliumBlock(NyliumBlock.Properties.create(Material.NETHER_PLANTS).sound(SoundType.NYLIUM).setRequiresTool().hardnessAndResistance(0.4f)));
