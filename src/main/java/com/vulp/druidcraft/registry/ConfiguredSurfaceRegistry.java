...
public class ConfiguredSurfaceRegistry {
  ...
  public static ConfiguredSurfaceBuilder<?> FERVID_JUNGLE = register("fervid_jungle", new ConfiguredSurfaceBuilder<>(SurfaceBuilder.NETHER, new SurfaceBuilderConfig(Blocks.SPONGE.getDefaultState(), Blocks.NETHERRACK.getDefaultState(), Blocks.NETHERRACK.getDefaultState())));
