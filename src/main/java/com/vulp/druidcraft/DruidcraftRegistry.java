    ...
    public static void onItemsRegistry(final RegistryEvent.Register<Item> itemRegistryEvent)
    {
        itemRegistryEvent.getRegistry().registerAll
                (
                        ...
                        ItemRegistry.stripped_darkwood_beam = new BlockItem(BlockRegistry.stripped_darkwood_beam, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.stripped_darkwood_beam.getRegistryName()),
                        ...
                        ItemRegistry.stripped_darkwood_small_beam = new BlockItem(BlockRegistry.stripped_darkwood_small_beam, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.stripped_darkwood_small_beam.getRegistryName()),
