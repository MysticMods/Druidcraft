    ...
    public static void onItemsRegistry(final RegistryEvent.Register<Item> itemRegistryEvent)
    {
        itemRegistryEvent.getRegistry().registerAll
                (
                        ...
                        ItemRegistry.black_bedroll = new BedrollItem(BlockRegistry.black_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.black_bedroll.getRegistryName()),
                        ItemRegistry.red_bedroll = new BedrollItem(BlockRegistry.red_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.red_bedroll.getRegistryName()),
                        ItemRegistry.green_bedroll = new BedrollItem(BlockRegistry.green_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.green_bedroll.getRegistryName()),
                        ItemRegistry.brown_bedroll = new BedrollItem(BlockRegistry.brown_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.brown_bedroll.getRegistryName()),
                        ItemRegistry.blue_bedroll = new BedrollItem(BlockRegistry.blue_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.blue_bedroll.getRegistryName()),
                        ItemRegistry.purple_bedroll = new BedrollItem(BlockRegistry.purple_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.purple_bedroll.getRegistryName()),
                        ItemRegistry.cyan_bedroll = new BedrollItem(BlockRegistry.cyan_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.cyan_bedroll.getRegistryName()),
                        ItemRegistry.light_gray_bedroll = new BedrollItem(BlockRegistry.light_gray_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.light_gray_bedroll.getRegistryName()),
                        ItemRegistry.gray_bedroll = new BedrollItem(BlockRegistry.gray_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.gray_bedroll.getRegistryName()),
                        ItemRegistry.pink_bedroll = new BedrollItem(BlockRegistry.pink_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.pink_bedroll.getRegistryName()),
                        ItemRegistry.lime_bedroll = new BedrollItem(BlockRegistry.lime_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.lime_bedroll.getRegistryName()),
                        ItemRegistry.yellow_bedroll = new BedrollItem(BlockRegistry.yellow_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.yellow_bedroll.getRegistryName()),
                        ItemRegistry.light_blue_bedroll = new BedrollItem(BlockRegistry.light_blue_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.light_blue_bedroll.getRegistryName()),
                        ItemRegistry.magenta_bedroll = new BedrollItem(BlockRegistry.magenta_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.magenta_bedroll.getRegistryName()),
                        ItemRegistry.orange_bedroll = new BedrollItem(BlockRegistry.orange_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.orange_bedroll.getRegistryName()),
                        ItemRegistry.white_bedroll = new BedrollItem(BlockRegistry.white_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.white_bedroll.getRegistryName()),
