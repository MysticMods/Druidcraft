...
public class DruidcraftRegistry {
    ...
    public static void onItemsRegistry(final RegistryEvent.Register<Item> itemRegistryEvent)
    {
        itemRegistryEvent.getRegistry().registerAll
                (
                        ...
                        ItemRegistry.bone_shield = new BasicShieldItem(new Item.Properties().group(DRUIDCRAFT).setTEISR(() -> ItemTileEntityRenderer::new), 72000, Items.BONE).setRegistryName(location("bone_shield")),
                        ...
                        ItemRegistry.chitin_shield = new BasicShieldItem(new Item.Properties().group(DRUIDCRAFT).setTEISR(() -> ItemTileEntityRenderer::new), 72000, ItemRegistry.chitin).setRegistryName(location("chitin_shield")),
                        ...
                        ItemRegistry.moonstone_shield = new BasicShieldItem(new Item.Properties().group(DRUIDCRAFT).setTEISR(() -> ItemTileEntityRenderer::new), 72000, ItemRegistry.moonstone).setRegistryName(location("moonstone_shield")),
                        ...
                        ItemRegistry.crate_temp = new BlockItem(BlockRegistry.crate_temp, new Item.Properties()).setRegistryName(BlockRegistry.crate_temp.getRegistryName()),
                        ...
                        ItemRegistry.white_bedroll = new BedrollItem(DyeColor.WHITE, BlockRegistry.white_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.white_bedroll.getRegistryName()),
                        ItemRegistry.orange_bedroll = new BedrollItem(DyeColor.ORANGE, BlockRegistry.orange_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.orange_bedroll.getRegistryName()),
                        ItemRegistry.magenta_bedroll = new BedrollItem(DyeColor.MAGENTA, BlockRegistry.magenta_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.magenta_bedroll.getRegistryName()),
                        ItemRegistry.light_blue_bedroll = new BedrollItem(DyeColor.LIGHT_BLUE, BlockRegistry.light_blue_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.light_blue_bedroll.getRegistryName()),
                        ItemRegistry.yellow_bedroll = new BedrollItem(DyeColor.YELLOW, BlockRegistry.yellow_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.yellow_bedroll.getRegistryName()),
                        ItemRegistry.lime_bedroll = new BedrollItem(DyeColor.LIME, BlockRegistry.lime_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.lime_bedroll.getRegistryName()),
                        ItemRegistry.pink_bedroll = new BedrollItem(DyeColor.PINK, BlockRegistry.pink_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.pink_bedroll.getRegistryName()),
                        ItemRegistry.gray_bedroll = new BedrollItem(DyeColor.GRAY, BlockRegistry.gray_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.gray_bedroll.getRegistryName()),
                        ItemRegistry.light_gray_bedroll = new BedrollItem(DyeColor.LIGHT_GRAY, BlockRegistry.light_gray_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.light_gray_bedroll.getRegistryName()),
                        ItemRegistry.cyan_bedroll = new BedrollItem(DyeColor.CYAN, BlockRegistry.cyan_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.cyan_bedroll.getRegistryName()),
                        ItemRegistry.purple_bedroll = new BedrollItem(DyeColor.PURPLE, BlockRegistry.purple_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.purple_bedroll.getRegistryName()),
                        ItemRegistry.blue_bedroll = new BedrollItem(DyeColor.BLUE, BlockRegistry.blue_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.blue_bedroll.getRegistryName()),
                        ItemRegistry.brown_bedroll = new BedrollItem(DyeColor.BROWN, BlockRegistry.brown_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.brown_bedroll.getRegistryName()),
                        ItemRegistry.green_bedroll = new BedrollItem(DyeColor.GREEN, BlockRegistry.green_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.green_bedroll.getRegistryName()),
                        ItemRegistry.red_bedroll = new BedrollItem(DyeColor.RED, BlockRegistry.red_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.red_bedroll.getRegistryName()),
                        ItemRegistry.black_bedroll = new BedrollItem(DyeColor.BLACK, BlockRegistry.black_bedroll, new Item.Properties().group(DRUIDCRAFT)).setRegistryName(BlockRegistry.black_bedroll.getRegistryName()),
    ...
    public static void onBlocksRegistry(final RegistryEvent.Register<Block> BlockRegistryEvent)
    {
        BlockRegistryEvent.getRegistry().registerAll
                (
                        ...
                        BlockRegistry.crate_temp = new CrateTempBlock(CrateTempBlock.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2.0f).harvestTool(ToolType.AXE)).setRegistryName(location("removed")),
    ...
    public static void onFeatureRegistry(final RegistryEvent.Register<Feature<?>> FeatureRegistryEvent)
    {
        ...
        FeatureRegistry.lavender = FeatureRegistry.register(registry, new LavenderPatchFeature(NoFeatureConfig::deserialize, BlockRegistry.lavender.getDefaultState()), "lavender");
