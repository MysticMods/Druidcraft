...
public class TravelPackModel<T extends LivingEntity> extends BipedModel<T> {
    ...
    public TravelPackModel() {
        ...
        link3.setRotationPoint(0.0F, 0.0F, 0.0F);
        straps.addChild(link3);
        link3.setTextureOffset(27, 35).addBox(-2.5F, -23.1F, 2.5F, 5, 0, 5, 0.0F, true);
        ...
        link2.setTextureOffset(24, 30).addBox(-3.5F, -5.1046F, 0.4908F, 7, 5, 0, 0.0F, false);
