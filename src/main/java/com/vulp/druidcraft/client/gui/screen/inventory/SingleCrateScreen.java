...
@OnlyIn(Dist.CLIENT)
public class SingleCrateScreen extends ContainerScreen<CrateContainer> implements IHasContainer<CrateContainer> {
    ...
    public SingleCrateScreen(CrateContainer container, PlayerInventory playerInv, ITextComponent iTextComponent) {
    ...
    protected void drawGuiContainerBackgroundLayer(MatrixStack matrixStack, float p_146976_1_, int p_146976_2_, int p_146976_3_) {
      ...
      this.blit(matrixStack, lvt_4_1_, lvt_5_1_, 0, 0, this.xSize, 3 * 18 + 17);
      this.blit(matrixStack, lvt_4_1_, lvt_5_1_ + 3 * 18 + 17, 0, 126, this.xSize, 96);
    }
}