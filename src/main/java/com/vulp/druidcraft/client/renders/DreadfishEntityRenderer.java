...
@OnlyIn(Dist.CLIENT)
public class DreadfishEntityRenderer extends MobRenderer<DreadfishEntity, DreadfishEntityModel>
{
    ...
    public DreadfishEntityRenderer(EntityRendererManager manager)
    {
    ...
    public static class RenderFactory implements IRenderFactory<DreadfishEntity>
    {
        ...
        {
            return new DreadfishEntityRenderer(manager);
        }
