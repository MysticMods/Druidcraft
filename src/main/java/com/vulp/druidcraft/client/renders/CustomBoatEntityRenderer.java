...
public class CustomBoatEntityRenderer extends EntityRenderer<CustomBoatEntity> {
    private static final ResourceLocation[] BOAT_TEXTURES = new ResourceLocation[]{new ResourceLocation(Druidcraft.MODID, "textures/entity/boat/darkwood.png"), new ResourceLocation(Druidcraft.MODID, "textures/entity/boat/elder.png")};
    protected final BoatModel modelBoat = new BoatModel();

    public CustomBoatEntityRenderer(EntityRendererManager renderManagerIn) {
    ...
    public static class RenderFactory implements IRenderFactory<CustomBoatEntity>
    {
        @Override
        public EntityRenderer<? super CustomBoatEntity> createRenderFor(EntityRendererManager manager)
        {
            return new CustomBoatEntityRenderer(manager);
        }
