...
@OnlyIn(Dist.CLIENT)
public abstract class Particle extends TexturedParticle implements IParticleRenderType {

    protected Particle(World world, double x, double y, double z) {
        super(world, x, y, z);
    }

    protected Particle(World world, double x, double y, double z, double motionX, double motionY, double motionZ) {
